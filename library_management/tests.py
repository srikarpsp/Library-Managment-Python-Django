...
from library_management.models import BookPost
User = get_user_model()

class BlPostAPITestCase(APITestCase):
    def setUp(self):
        user_obj = User(username='sangi', email='test@test.com')
        user_obj.set_password("sangi")
        user_obj.save()
